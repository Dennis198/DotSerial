namespace DotSerial.Common
{
    ...
    public interface ISerial<T>
    {
        ...
        public static abstract T Serialize(object obj);
        ...
        public static abstract U Deserialize<U>(T serialObj);
        ...
        public static abstract void SaveToFile(string path, T serialObj);
        ...
        public static abstract void SaveToFile(string path, object? obj);
        ...
        public static abstract U LoadFromFile<U>(string path);
    }
}
