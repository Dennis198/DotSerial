...
namespace DotSerial.Tests
{
    public class DSNodeTests
    {
        ...
        public void Create(StategyType strategy)
        {
            // Arrange
        ...
        [InlineData(StategyType.Xml)]
        [InlineData(StategyType.Yaml)]
        public void ToNode(StategyType strategy)
        {
            // Arrange
        ...
        [InlineData(StategyType.Xml)]
        [InlineData(StategyType.Yaml)]
        public void Stringify(StategyType strategy)
        {
            // Arrange
            var example = ExampleClass.CreateTestDefault();
            ...
            // Act
            var result = tmp.Stringify(strategy);
        ...
        [InlineData(StategyType.Xml)]
        [InlineData(StategyType.Yaml)]
        public void FromString(StategyType strategy)
        {
            // Arrange
            var example = ExampleClass.CreateTestDefault();
            var tmp = DSNode.ToNode(example, strategy);
            var outputString = tmp.Stringify(strategy);
        ...
        [InlineData(StategyType.Xml)]
        [InlineData(StategyType.Yaml)]
        public void Primitive(StategyType strategy)
        {
            // Arrange
            double tmp = 1234.45;
            var node = DSNode.ToNode(tmp, strategy);
            string outputString = node.Stringify(strategy);
        ...
        [InlineData(StategyType.Xml)]
        [InlineData(StategyType.Yaml)]
        public void Primitive_Null(StategyType strategy)
        {
            // Arrange
            string? tmp = null;
            var node = DSNode.ToNode(tmp, strategy);
        ...
        [InlineData(StategyType.Xml)]
        [InlineData(StategyType.Yaml)]
        public void Primitive_Empty(StategyType strategy)
        {
            // Arrange
        ...
        [InlineData(StategyType.Xml)]
        [InlineData(StategyType.Yaml)]
        public void PrimitiveSpecialChar(StategyType strategy)
        {
            // Arrange
            string tmp = "{{}<><:;[[]-?!#!";
            var node = DSNode.ToNode(tmp, strategy);
        ...
        [InlineData(StategyType.Xml)]
        [InlineData(StategyType.Yaml)]
        public void List_Empty(StategyType strategy)
        {
            // Arrange
            double[]? tmp = [];
            var node = DSNode.ToNode(tmp, strategy);
        ...
        [InlineData(StategyType.Xml)]
        [InlineData(StategyType.Yaml)]
        public void Dictionary_Empty(StategyType strategy)
        {
            // Arrange
            Dictionary<string, double> tmp = [];
            var node = DSNode.ToNode(tmp, strategy);
        ...
        [InlineData(StategyType.Xml)]
        [InlineData(StategyType.Yaml)]
        public void ToObject_ExampleClass(StategyType strategy)
        {
            // Arrange
            var example = ExampleClass.CreateTestDefault();
            var tmp = DSNode.ToNode(example, strategy);
        ...
        [InlineData(StategyType.Xml)]
        [InlineData(StategyType.Yaml)]
        public void ToObject_EmptyClass(StategyType strategy)
        {
            // Arrange
        ...
        [InlineData(StategyType.Xml)]
        [InlineData(StategyType.Yaml)]
        public void ToObject_ListFirstElementNull(StategyType strategy)
        {
            // Arrange
        ...
        [InlineData(StategyType.Xml)]
        [InlineData(StategyType.Yaml)]
        public void ToObject_NoAttributeClass(StategyType strategy)
        {
            // Arrange
        ...
        [InlineData(StategyType.Xml)]
        [InlineData(StategyType.Yaml)]
        public void ToObject_AccessModifierClass(StategyType strategy)
        {
            // Arrange
        ...
        [InlineData(StategyType.Xml)]
        [InlineData(StategyType.Yaml)]
        public void ToObject_SimpleClass(StategyType strategy)
        {
            // Arrange
        ...
        [InlineData(StategyType.Xml)]
        [InlineData(StategyType.Yaml)]
        public void ToObject_NullClass(StategyType strategy)
        {
            // Arrange
        ...
        [InlineData(StategyType.Xml)]
        [InlineData(StategyType.Yaml)]
        public void ToObject_IEnumerableClass(StategyType strategy)
        {
            // Arrange
        ...
        [InlineData(StategyType.Xml)]
        [InlineData(StategyType.Yaml)]
        public void ToObject_NestedClasss(StategyType strategy)
        {
            // Arrange
        ...
        [InlineData(StategyType.Xml)]
        [InlineData(StategyType.Yaml)]
        public void ToObject_NestedNestedClass(StategyType strategy)
        {
            // Arrange
        ...
        [InlineData(StategyType.Xml)]
        [InlineData(StategyType.Yaml)]
        public void ToObject_PrimitiveClass(StategyType strategy)
        {
            // Arrange
        ...
        [InlineData(StategyType.Xml)]
        [InlineData(StategyType.Yaml)]
        public void ToObject_DictionaryClass(StategyType strategy)
        {
            // Arrange
        ...
        [InlineData(StategyType.Xml)]
        [InlineData(StategyType.Yaml)]
        public void ToObject_EnumClass(StategyType strategy)
        {
            // Arrange
        ...
        [InlineData(StategyType.Xml)]
        [InlineData(StategyType.Yaml)]
        public void ToObject_DateTimeClass(StategyType strategy)
        {
            // Arrange
        ...
        [InlineData(StategyType.Xml)]
        [InlineData(StategyType.Yaml)]
        public void ToObject_StructClass(StategyType strategy)
        {
            // Arrange
        ...
        [InlineData(StategyType.Xml)]
        [InlineData(StategyType.Yaml)]
        public void ToObject_RecordClass(StategyType strategy)
        {
            // Arrange
        ...
        [InlineData(StategyType.Xml)]
        [InlineData(StategyType.Yaml)]
        public void ToObject_ParsableClass(StategyType strategy)
        {
            // Arrange
        ...
        [InlineData(StategyType.Xml)]
        [InlineData(StategyType.Yaml)]
        public void ToObject_PathClass(StategyType strategy)
        {
            // Arrange
        ...
        [InlineData(StategyType.Xml)]
        [InlineData(StategyType.Yaml)]
        public void ToObject_ClassWithoutParameterlessConstructor(StategyType strategy)
        {
            // Arrange
        ...
        [InlineData(StategyType.Xml)]
        [InlineData(StategyType.Yaml)]
        public void ToObject_ClassRecordNoParameterlessConstructor(StategyType strategy)
        {
            // Arrange
        ...
        [InlineData(StategyType.Xml)]
        [InlineData(StategyType.Yaml)]
        public void ToObject_PrimitiveClassIEnumarable(StategyType strategy)
        {
            // Arrange
        ...
        [InlineData(StategyType.Xml)]
        [InlineData(StategyType.Yaml)]
        public void ToObject_MultiDimClassIEnumarble(StategyType strategy)
        {
            // Arrange
        ...
        [InlineData(StategyType.Xml)]
        [InlineData(StategyType.Yaml)]
        public void ToObject_EmptyObjectClass(StategyType strategy)
        {
            // Arrange
        ...
        [InlineData(StategyType.Xml)]
        [InlineData(StategyType.Yaml)]
        public void ToObject_ClassWithOneList(StategyType strategy)
        {
            // Arrange
        ...
        [InlineData(StategyType.Xml)]
        [InlineData(StategyType.Yaml)]
        public void ToObject_ClassWithOneDictionary(StategyType strategy)
        {
            // Arrange
        ...
        [InlineData(StategyType.Xml)]
        [InlineData(StategyType.Yaml)]
        public void ToObject_ClassWithOnePrimitive(StategyType strategy)
        {
            // Arrange
        ...
        [InlineData(StategyType.Xml)]
        [InlineData(StategyType.Yaml)]
        public void ToObject_ClassSpecialCharsKeys(StategyType strategy)
        {
            // Arrange
            var example = ClassSpecialCharsKeys.CreateTestDefault();
            var tmp = DSNode.ToNode(example, strategy);
            var resultString = tmp.Stringify(strategy);
        ...
        [InlineData(StategyType.Xml)]
        [InlineData(StategyType.Yaml)]
        public void ToObject_ClassSpecialCharsValue(StategyType strategy)
        {
            // Arrange
